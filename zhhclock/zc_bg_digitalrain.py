...
_DP_Y = const(1)
_DP_SPEED = const(2)
_DP_TRAIL_LENGTH = const(3)
_DP_HEAD_BRI = const(4)
...
class DigitalRain(HaloBackground):
    def __init__(self, zip_, mdisplaylist, options=None):
        ...
        ### [x, y, speed, trail_length, head_bri]
        #self._rain_drops = []   ### TODO - consider 1D array.array of 5 floats per entry and using head_bri 0.0 to turn them off
        self._max_drops = 12
